...
Public Class Form1
    ...
    Sub Koneksi()
        LokasiData = "Driver={MySQL ODBC 3.51 Driver};Database=dbjnm;server=localhost;uid=root"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Call Koneksi()
        Dim edit As String = "update tbl_mahasiswa set namamhs='" & TextBox2.Text & "',alamatmhs='" & TextBox3.Text & "',teleponmhs='" & TextBox4.Text & "',jurusanmhs='" & ComboBox1.Text & "' where nimmhs='" & TextBox1.Text & "'"
